...
module.exports = function beginBlockHandlerFactory(
  ...
  async function beginBlockHandler({ header: { height } }) {
    ...
    const identityTransaction = identityRepository.createTransaction();
    identityTransaction.startTransaction();
    blockExecutionDBTransactions.setIdentityTransaction(identityTransaction);
