...
class IsolatedDpp {
  ...
  constructor(defaultExecutionOptions, dpp, snapshot, dataProvider, isolateOptions) {
    this.initializeFacades(defaultExecutionOptions, dpp, snapshot, dataProvider, isolateOptions);
  }

  initializeFacades(defaultExecutionOptions, dpp, snapshot, dataProvider, isolateOptions) {
