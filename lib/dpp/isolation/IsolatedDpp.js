...
class IsolatedDpp {
  ...
  constructor(defaultExecutionOptions, dpp, snapshot, dataProvider, isolateOptions) {
    ...
    this.initializeDataContractFacade(defaultExecutionOptions, dpp, bootstrapIsolate);
    this.initializeDocumentFacade(defaultExecutionOptions, dpp, bootstrapIsolate);
    this.initializeIdentityFacade(defaultExecutionOptions, dpp, bootstrapIsolate);
    this.initializeStateTransitionFacade(defaultExecutionOptions, dpp, bootstrapIsolate);
  }
   ...
   * @param defaultExecutionOptions
   * @param dpp
   * @param bootstrapIsolate
   */
  initializeDataContractFacade(defaultExecutionOptions, dpp, bootstrapIsolate) {
    this.dataContract = {
   ...
   * @param bootstrapIsolate
   */
  initializeDocumentFacade(defaultExecutionOptions, dpp, bootstrapIsolate) {
    this.document = {
      create: wrapDppCreateMethod(
        bootstrapIsolate,
        'dpp.document',
   ...
   * @param bootstrapIsolate
   */
  initializeIdentityFacade(defaultExecutionOptions, dpp, bootstrapIsolate) {
    this.identity = {
      create: wrapDppCreateMethod(
        bootstrapIsolate,
        'dpp.identity',
   ...
   * @param bootstrapIsolate
   */
  initializeStateTransitionFacade(defaultExecutionOptions, dpp, bootstrapIsolate) {
