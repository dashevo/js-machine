...
class IsolatedDataProviderWrapper {
  ...
  async fetchIdentity(id) {
    // console.log('dateFetch', Date.now());
    // console.log('fetching identity', id);
    // console.time('fetchidentity');
    // fetchIdentityRequest = id;
    //
    // // wait until id will be replaced by identity JSON
    // // from main thread
    // while (!fetchIdentityResponse) {
    //   await next();
    //   //await Promise.resolve();
    // }
    //
    // // if we've found an identity return class instance
    // if (fetchIdentityResponse) {
    //   console.timeEnd('fetchidentity');
    //   return new Identity(fetchIdentityResponse);
    // }
    //
    // // return null otherwise
    // return fetchIdentityResponse;
