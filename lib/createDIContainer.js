 ...
 * @param {string} options.TENDERMINT_PORT
 * @param {boolean} options.RATE_LIMITER_ACTIVE
 * @param {number} options.RATE_LIMITER_MAX_TRANSITIONS_PER_ID
 * @param {number} options.RATE_LIMITER_PER_BLOCK_INTERVAL
