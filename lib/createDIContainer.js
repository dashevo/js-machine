...
const IdentitiesLevelDBRepository = require('./identities/IdentitiesLevelDBRepository');
const IdentityState = require('./identities/IdentityState');
...
async function createDIContainer(options) {
   ...
   */
  container.register({
    identitiesRepository: asClass(IdentitiesLevelDBRepository),

    identityState: asClass(IdentityState)
      .singleton(),
  });
